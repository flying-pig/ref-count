#define REF_COUNT_PLATFORM "Mac OS"
...
//
#  include <config/posix_features.h>
#  ifndef REF_COUNT_HAS_STDINT_H
...
#    define REF_COUNT_NO_STDC_NAMESPACE
#  endif
...
#  if !defined(REF_COUNT_HAS_PTHREADS)
// MPTasks support is deprecated/removed from REF_COUNT:
//#    define REF_COUNT_HAS_MPTASKS
...
#ifdef REF_COUNT_HAS_PTHREADS
#  define REF_COUNT_HAS_THREADS
#endif

// The remote call manager depends on this.
#    define REF_COUNT_BIND_ENABLE_PASCAL
