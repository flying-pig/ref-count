...
#   define REF_COUNT_HAS_PRAGMA_DETECT_MISMATCH
#endif
...
#if !__has_feature(cxx_exceptions) && !defined(REF_COUNT_NO_EXCEPTIONS)
#  define REF_COUNT_NO_EXCEPTIONS
#endif

#if !__has_feature(cxx_rtti) && !defined(REF_COUNT_NO_RTTI)
#  define REF_COUNT_NO_RTTI
#endif

#if !__has_feature(cxx_rtti) && !defined(REF_COUNT_NO_TYPEID)
#  define REF_COUNT_NO_TYPEID
#endif

#if defined(__int64) && !defined(__GNUC__)
#  define REF_COUNT_HAS_MS_INT64
#endif
...
// See https://svn.REF_COUNT.org/trac/REF_COUNT/ticket/10418
...
//
// The REF_COUNT_FALLTHROUGH macro can be used to annotate implicit fall-through
// between switch labels.
//
#if __cplusplus >= 201103L && defined(__has_warning)
#  if __has_feature(cxx_attributes) && __has_warning("-Wimplicit-fallthrough")
#    define REF_COUNT_FALLTHROUGH [[clang::fallthrough]]
#  endif
#endif
...
// creating the Clang release (see https://github.com/REF_COUNTorg/config/pull/39#issuecomment-59927873)
...
#  define REF_COUNT_COMPILER "Clang version " __clang_version__
#endif

// Macro used to identify the Clang compiler.
#define REF_COUNT_CLANG 1
